...
<input type="button" value="Créer au format PDF *" id="submit_document_activite_pdf" 
class="container_mobile submit_dc"
style="width:350px;" 
onclick="submit_form_document_activite(event, this);enregistrer_clic_pdf();">

action="./generate_pdf.php" 
        <button action="./generate_pdf.php" type="submit">Ajouter Client</button>
