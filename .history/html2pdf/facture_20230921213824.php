...
<h1>Créez votre propre phrase</h1>
    <input type="text" id="phraseInput" placeholder="Écrivez votre texte ici...">
    <button onclick="afficherPhrase()">Afficher la phrase</button>
    <p id="phraseAffichee"></p>
...
<script>
        function afficherPhrase() {
            ...
            // Afficher la phrase avec le texte de l'utilisateur
            var phraseAffichee = document.getElementById("phraseAffichee");
            phraseAffichee.textContent = "La phrase que vous avez écrite : " + texteUtilisateur;
        }
    </script>
</body>
</html>
