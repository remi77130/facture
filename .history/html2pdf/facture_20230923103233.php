...
<body>
    ...
    <form id="contratForm">
       ...
       placeholder="Nom de l'entreprise" required>dont le siége sociual est situé à 
        

        <input type="text" id="adresse_entreprise" 
        placeholder=" Nom et Prénom de l'employeur" required>, représentée par 
    ...
    <script>
        function genererContrat() {
            ...
            var contratHTML = `
                ...
                ${adresse_entreprise}, représentée par ${civilite} agissant en qualité d'employeur
