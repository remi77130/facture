...
<form id="entreprise-form">
    ...
    <input style="background-color: #007bff; type=" id="adresse-entreprise" required><br>
...
<!-------    TABLEAU ENTREPRISE ------>
    ...
    <script>
      // Convertir le contenu en image (utilisez une bibliothèque appropriée)
const contentImage = document.getElementById('client-form').toDataURL("image/png");

// Initialiser jsPDF
const doc = new jsPDF();

// Ajouter l'image au PDF
doc.addImage(contentImage, 'PNG', 10, 10, 190, 100);
