...
<form>
    <h2>Informations sur les produits achetés :</h2>
...
<!-------    TABLEAU ENTREPRISE ------>
    ...
    var nbr_produit = document.getElementById("prix_produit").value;
    ...
    doc.text(nombre_produits, 4, 155);
    doc.text(prix_produit, 4, 155);
