...
<body>
    ...
    <div class="header">
       ...
       <form id="client-form">
        ...
        <input type="text" id="tva" required><br>
...
<!-------    TABLEAU ENTREPRISE ------>
    ...
    doc.roundedRect(148, 2, 60, 50, 2,2,2,2); // x, y, largeur, hauteur, rayon de coins arrondis

     // Ajoutez un rectangle avec une couleur de fond pour simuler l'ombre portée
     doc.setFillColor(192, 192, 192); // Couleur de l'ombre portée (gris)
    doc.rect(ombreX, ombreY, ombreLargeur, ombreHauteur, 'F'); // Remplissage
