...
<!-------    TABLEAU ENTREPRISE ------>
    ...
    doc.text(nom, 5, 10);
    doc.text(email, 5, 15);
    doc.rect(5, 2, 60, 30); // x, y, largeur, hauteur border


    // Mise en page : Informations de l'entreprise en haut à droite
    doc.text(nomEntreprise, 200, 10, null, null, "right");
    doc.text(adresseEntreprise, 200, 15, null, null, "right");
    doc.rect(145, 2, 60, 30); // x, y, largeur, hauteur border
