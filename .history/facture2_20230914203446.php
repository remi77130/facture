...
<!-------    FORM ENTREPRISE ------>
    ...
    var adresseEntreprise = document.getElementById("adresse-entreprise").value;
       ...
       // doc.fromHTML(document.getElementById("container_client_info"), 10, 10);
...
// Default export is a4 paper, portrait, using millimeters for units
    ...
    doc.fromHTML(document.getElementById("container_client_info"), 10, 10);
    doc.fromHTML(document.getElementById("container_entreprise_info"), 140, 10);

  // Mise en page : Informations de l'entreprise en haut à droite
   doc.fromHTML(nomEntreprise, 200, 5, null, null, "right");
   doc.fromHTML(adresseEntreprise, 200, 10, null, null, "right");
