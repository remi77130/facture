...
// Convertir le formulaire en une image (PNG)
const formImage = new Image();
formImage.src = 'data:image/png;base64,iVBORw0KGgo...'; // Remplacez par le code de l'image de votre formulaire

// Insérer l'image dans le PDF
doc.addImage(formImage, 'PNG', 10, 10, 190, 100);
