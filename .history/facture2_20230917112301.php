...
<h3>Produit</h3>
<label for="ref_produit">Nom du produit</label>
    <input type="text" id="ref_produit" required><br>

    <label for="nbr_produit">Adresse de l'entreprise :</label>
    <input type="text" id="nbr_produit" required><br>
...
<!-------    TABLEAU ENTREPRISE ------>
    ...
    var nbr_produit = document.getElementById("nbr_produit").value;
    ...
    doc.text(ref_produit, 4, 150);
    doc.text(nbr_produit, 4, 155);
