...
<!-------    TABLEAU ENTREPRISE ------>
    ...
    doc.setFontSize(10);
    doc.text(nom, 200, 8);
    doc.text(prenom, 200, 13);
    doc.text(adresse, 200, 18);
    doc.text(email, 200, 23);
    ...
    doc.text(nomEntreprise, 5, 8, null, null, "left");
    doc.text(adresseEntreprise, 5, 13, null, null, "left");
