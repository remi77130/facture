...
// Default export is a4 paper, portrait, using millimeters for units
  ...
  doc.text("Informations de l'entreprise :", 140, 10, null, null, "right");
    doc.text("Nom de l'entreprise : " + nomEntreprise, 140, 20, null, null, "right");
    doc.text("Adresse de l'entreprise : " + adresseEntreprise, 140, 30, null, null, "right");
