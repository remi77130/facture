...
<h3>Produit achetée</h3>
    ...
    <input type="number" step="0.01" id="prix_produit" required><br>
      ...
      <!-- Ajoutez un champ pour choisir une image -->
      <label for="choisir-image">Choisir une image :</label>
    <input type="file" id="imgData"><br>
...
<!-------    TABLEAU ENTREPRISE ------>
 ...
 // Intégrer une image
 var imgData = ""; // Remplacez par le chemin de votre image
   ...
   // Dessiner une boîte avec des coins arrondis autour de la référence du produit
    doc.roundedRect(2, 90, 90, 8, 1, 1, "S"); // x, y, largeur, hauteur, rayon des coins (3 dans cet exemple)
    doc.text("Référence du produit : " + reference_produit, 10, 95); // Ajustez la position en conséquence
